...
select count(*) from HANACLOUD_IRIS_DATA_TEST_TBL

select * from HANACLOUD_IRIS_DATA_TEST_TBL WITH HINT(NO_VIRTUAL_TABLE_REPLICA)

ALTER VIRTUAL TABLE HANACLOUD_IRIS_DATA_TEST_TBL DROP REPLICA;

select * from M_VIRTUAL_TABLE_REPLICA;

-- Replicating Tables from Remote Sources
CREATE COLUMN TABLE RT_IRIS_DATA_TRAIN_TBL LIKE HANACLOUD_IRIS_DATA_TRAIN_TBL;

CREATE REMOTE SUBSCRIPTION SUB ON HANACLOUD_IRIS_DATA_TRAIN_TBL TARGET TABLE RT_IRIS_DATA_TRAIN_TBL;
